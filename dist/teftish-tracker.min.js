							...
							(function () {
								...
								var x = (function e(t) {
									...
									var l,
										...
										v = "Object",
										w = n ? v : "ScriptBridgingProxyObject",
										O = n ? v : "Environment",
										E =
											n && r.java
												? "JavaPackage"
												: m(r.java),
										M = n ? v : "RuntimeObject",
										P = /\bJava/.test(E) && r.java,
										I = P && m(r.environment) == O,
										C = P ? "a" : "α",
										A = P ? "b" : "β",
										R = r.document || {},
					...
					var u = "undefined" != typeof window,
						...
						h = function (e, t, r, n) {
							...
							i.open("POST", e),
								...
								(i.withCredentials = r.ignoreOwnVisits),
								i.send(JSON.stringify(t));
						},
						m = (r.detect = function () {
							var e = document.querySelector(
								"[data-teftish-domain-id]"
							);
							if (null != e) {
								var t =
										e.getAttribute("data-teftish-server") ||
										"",
									r = e.getAttribute(
										"data-teftish-domain-id"
									),
									n =
										e.getAttribute("data-teftish-opts") ||
										"{}";
								S(t, JSON.parse(n)).record(r);
							}
						}),
						S = (r.create = function (e, t) {
							t = (function () {
								var e =
										arguments.length > 0 &&
										void 0 !== arguments[0]
							...
							if (
								...
								return (
									console.warn(
										"Teftish ignores you because you are on localhost"
									),
									a
								);
							if (
								...
								return (
									console.warn(
										"Teftish ignores you because you are a bot"
									),
									a
								);
							return {
								...
								action: function (e, r, n) {
									h(
										...
										function (e) {
											var t =
												e.data.createAction.payload.id;
											return !0 === c(t)
												? console.warn(
														"Teftish ignores you because this is your own site"
													)
